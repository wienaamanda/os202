...
4. [Git basic command](http://guides.beanstalkapp.com/version-control/common-git-commands.html)<br>
...
5. [What is an operating system?](https://edu.gcfglobal.org/en/computerbasics/understanding-operating-systems/1/)<br>
...
8. [Virtual memory](https://www.youtube.com/watch?v=qlH4-oHnBb8)<br>
Virtual memory take program addresses and maps them to RAM address

9. [Microkernel](https://www.geeksforgeeks.org/microkernel-in-operating-systems/)<br>
...
10. [Interrupt](https://en.wikipedia.org/wiki/Interrupt)<br>
